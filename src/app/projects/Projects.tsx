...
// 
    const tiETeDialogData = [
        new DialogData("./assets/TiETe/game.png", "./assets/TiETe/img1.png", "./assets/TiETe/img2.png", "/videos/Ti&Te_Game.MP4",
        ...
        new DialogData("./assets/TiETe/turtleAltarComplet.png", "./assets/TiETe/turtleAltar.png", "./assets/TiETe/turtleAltarEnemy.png", "/videos/Ti&Te_turtleMovement.MP4",
        ...
        new DialogData("./assets/TiETe/stincat.png", "./assets/TiETe/catfish.png", "./assets/TiETe/cameowrao.png", "/videos/Ti&Te_CameowraoExplosion.MP4",
        ...
        new DialogData("./assets/TiETe/stincatEnemy.png", "./assets/TiETe/catfishEnemy.png", "./assets/TiETe/cameowraoEnemy.png", "/videos/Ti&Te_Tentacle.MP4",

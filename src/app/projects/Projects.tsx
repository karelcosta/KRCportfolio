...
// 
    const tiETeDialogData = [
        new DialogData("/assets/game.png", "/assets/img1.png", "/assets/img2.png", "/KRCportfolio/videos/TiETe_Game.MP4",
        ...
        new DialogData("/assets/turtleAltarComplet.png", "/assets/turtleAltar.png", "/assets/turtleAltarEnemy.png", "/KRCportfolio/videos/TiETe_turtleMovement.MP4",
        ...
        new DialogData("/assets/stincat.png", "/assets/catfish.png", "/assets/cameowrao.png", "/KRCportfolio/videos/TiETe_CameowraoExplosion.MP4",
        ...
        new DialogData("/assets/stincatEnemy.png", "/assets/catfishEnemy.png", "/assets/cameowraoEnemy.png", "/KRCportfolio/videos/TiETe_Tentacle.MP4",

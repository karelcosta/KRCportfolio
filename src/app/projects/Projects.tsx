...
// 
    const tiETeDialogData = [
        ...
        new DialogData("./assets/TiETe/turtleAltarComplet.png", "./assets/TiETe/turtleAltar.png", "./assets/TiETe/turtleAltarEnemy.png", "./videos/turtleMovement.MP4",
        ...
        new DialogData("./assets/TiETe/stincat.png", "./assets/TiETe/catfish.png", "./assets/TiETe/cameowrao.png", "./videos/CameowraoExplosion.MP4",
        ...
        new DialogData("./assets/TiETe/stincatEnemy.png", "./assets/TiETe/catfishEnemy.png", "./assets/TiETe/cameowraoEnemy.png", "./videos/Tentacle.MP4",

...
export default function Sidebar() {
  ...
  return (
    <div className="  w-screen bg-[#010409] h-[80px] fixed left-0 top-0 flex flex-row justify-between   p-6 shadow-lg text-white z-50">
      {/* <div className="flex">

      </div> */}
      <h1 className="text-7xl  font-[family-name:var(--font-jersey-10)]"> Karel </h1>
